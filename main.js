...
function loadProject(title, meta, desc, imgs) {
...
document.querySelectorAll('.proj').forEach(el => {
  el.addEventListener('click', function() {
    ...
    loadProject(this.dataset.title, this.dataset.meta, this.dataset.desc, this.dataset.imgs);
...
if (first) {
  loadProject(first.dataset.title, first.dataset.meta, first.dataset.desc, first.dataset.imgs);
}
